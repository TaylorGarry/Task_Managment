...
const EmployeeCreateConfirmModal = ({
  ...
  const rows = [
    ...
    { label: "DOB", value: summary.dob },
    { label: "Designation", value: summary.designation },
    { label: "Personal Email", value: summary.personalEmailId },
    { label: "Blood Group", value: summary.bloodGroup },
    { label: "Emergency Name", value: summary.emergencyContactName },
    { label: "Emergency Number", value: summary.emergencyContactNumber },
    { label: "Emergency Relation", value: summary.emergencyContactRelation },
    { label: "Permanent Address", value: summary.permanentAddress },
    { label: "Current Address", value: summary.currentAddress },
