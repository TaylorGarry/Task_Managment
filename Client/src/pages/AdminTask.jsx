...
=======
    <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      <Toaster position="top-right" />
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700&family=DM+Serif+Display&display=swap');
      `}</style>

      <div className="absolute inset-0 bg-[radial-gradient(60%_50%_at_85%_0%,rgba(37,99,235,0.12),rgba(248,250,252,0))]" />
      <div className="absolute inset-0 bg-[radial-gradient(55%_50%_at_0%_30%,rgba(14,116,144,0.10),rgba(248,250,252,0))]" />
              ...
              >
                ...
                <div className="mt-6 border-t border-slate-200 pt-4">
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <button
                      onClick={() => handleUpdateStatus(task._id)}
                      className="flex-1 rounded-2xl bg-blue-600 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-700"
                    >
                      Update Status
                    </button>
            ...
            <div className="w-full max-w-lg overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl">
              <div className="border-b border-slate-200 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-5 text-white">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <button
                    onClick={closeRemarkPopup}
                    className="h-9 w-9 rounded-full border border-white/30 text-white/90 transition hover:text-white hover:bg-white/15"
                  >
                    <X size={22} />
                  </button>
                </div>
