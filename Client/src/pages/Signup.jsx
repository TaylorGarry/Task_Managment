...
const Signup = () => {
  ...
  const isCoreTeam = watch("isCoreTeam", false);  
  ...
  payload.shiftLabel = data.shiftLabel;
      ...
      const resultAction = isCoreTeam
        ? await dispatch(createCoreTeamUser(payload))
        : await dispatch(signupUser(payload));

      if (
        (isCoreTeam && createCoreTeamUser.fulfilled.match(resultAction)) ||
        (!isCoreTeam && signupUser.fulfilled.match(resultAction))
      ) {
        toast.success(
          isCoreTeam
            ? "Core team user created successfully!"
