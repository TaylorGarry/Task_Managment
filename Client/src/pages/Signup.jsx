...
//         shiftLabel: data.shiftLabel, // ✅ Add shift here
//       };
...
//               defaultValue="4pm-1am"
//               className="w-full p-2 border rounded"
//               disabled={creatingUser}
//             >
//               <option value="4pm-1am">4 PM - 1 AM</option>
//               <option value="5pm-2am">5 PM - 2 AM</option>
//               <option value="6pm-3am">6 PM - 3 AM</option>
//               <option value="1am-10am">1 AM - 10 AM</option>
//             </select>
...
const Signup = () => {
  ...
  // ✅ Must match backend shift mapping
  const shiftOptions = [
      ...
      <div className="flex justify-center items-center h-screen bg-gray-100">
        <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* ✅ Shift Selection (fully backend-aligned) */}
            <select
              {...register("shiftLabel", { required: true })}
              defaultValue="4pm-1am"
              className="w-full p-2 border rounded"
