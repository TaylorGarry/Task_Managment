...
//   status: {
//     type: String,
//     enum: ["P", "WO", "L", "NCNS", "UL", "LWP", "BL", "H", "LWD", "HD", "OT", "FWO", "Exit", "EXIT", ""],
//     default: "P"
//   },
...
// rosterSchema.index({ rosterStartDate: 1, rosterEndDate: 1, month: 1, year: 1 });
...
// rosterSchema.index({ "weeks.weekNumber": 1, "weeks.startDate": 1, "weeks.endDate": 1 });
